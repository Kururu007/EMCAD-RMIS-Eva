...
from trainer import trainer_qata

parser = argparse.ArgumentParser()

parser.add_argument('--root_path', type=str,
                    default='./data/QaTa_EMCAD/train', help='root dir for data')
parser.add_argument('--volume_path', type=str,
                    default='./data/QaTa_EMCAD/val', help='root dir for validation volume data')
